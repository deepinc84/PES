...
/**
 * Temporary accessible fallback for the supplied PES artwork. The binary brand
 * files were not included in this checkout; replace this contents-only fallback
 * with next/image when the approved horizontal artwork is mounted.
 */
